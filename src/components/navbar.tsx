    ...
    >
      <div className="container mx-auto flex items-center justify-between">
        ...
        >
          ...
          <NavItem href="/TentangKami">Tentang Kami</NavItem>
          <NavItem href="/Produk">Produk</NavItem>
          <NavItem href="/Informasi">Informasi</NavItem>
          <NavItem href="/HubungiKami">Hubungi Kami</NavItem>
        </ul>
