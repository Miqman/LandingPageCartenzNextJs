    ...
    <div className="relative min-h-screen w-full bg-[url('/image/bg_hero.png')] bg-cover bg-no-repeat">
      ...
      <div className='grid min-h-screen px-8'>
        <div className='container relative z-10 mx-auto my-auto'>
          <h1 className='text-3xl font-semibold leading-[3rem] text-white md:max-w-full md:text-7xl md:leading-[5.488rem] lg:max-w-4xl lg:text-7xl lg:leading-[5.488rem]'>
            CARTENZ SATSET INDONESIA GASPOL
          </h1>

          <p className='mb-10 mt-8 w-full text-base font-light leading-9 text-white md:max-w-full md:text-2xl md:leading-[37.2px] lg:max-w-4xl'>
            {t('heroDescription')}
          </p>
        </div>
      </div>

      <div className='absolute bottom-0 left-0 right-0 z-10 hidden px-8 md:block'>
        <div className='container flex flex-wrap justify-center gap-14 py-8 md:justify-between'>
          <div className=''>
